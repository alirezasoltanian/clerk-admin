    ...
    <div>
      <div className="sm:max-w-[480px]">
        {files && files[0]?.preview && (
          <div className="w-32 h-32 overflow-hidden border-4 m-auto border-slate-300 rounded-full bg-slate-400">
            <Image
              width={400}
              height={400}
              alt="New Profile Image"
              className="object-cover w-full h-full"
              src={cropData ? cropData : files[0]?.preview}
            />
          </div>
        )}
              ...
              isDragActive ? (
                ...
                <div className="grid place-items-center gap-1 sm:px-5">
                  ...
                  <p className="mt-2 text-base font-medium text-muted-foreground">
                    Drag {`${maxFiles}`} drop file here, or click to select file
                  </p>
